...
_TRANSITIONS = {
    "SLEEPING": {"IDLE", "BACKGROUND", "ATTENTION"},
    "BACKGROUND": {"IDLE", "ATTENTION", "CURIOUS", "SLEEPING"},
    "ATTENTION": {"IDLE", "CURIOUS", "THINKING", "IMPORTANT", "LISTENING", "SLEEPING"},
    "CURIOUS": {"IDLE", "THINKING", "LISTENING", "IMPORTANT", "ATTENTION"},
    "LISTENING": {"IDLE", "THINKING", "PROCESSING", "IMPORTANT", "LEARNING"},
    "THINKING": {"IDLE", "PROCESSING", "IMPORTANT", "SUCCESS", "WAITING"},
    "PROCESSING": {"IDLE", "IMPORTANT", "SUCCESS", "ERROR", "WAITING"},
    "LEARNING": {"IDLE", "IMPORTANT", "SUCCESS"},
    "IMPORTANT": {"IDLE", "WARNING", "SUCCESS", "ERROR", "WAITING"},
    "WAITING": {"IDLE", "IMPORTANT", "WARNING", "SUCCESS"},
    "WARNING": {"IDLE", "IMPORTANT", "ERROR", "SUCCESS"},
    "SUCCESS": {"IDLE", "ATTENTION", "SLEEPING"},
    "ERROR": {"IDLE", "WARNING"},
}
